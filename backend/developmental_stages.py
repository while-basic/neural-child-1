...
class DevelopmentalStage(Enum):
    ...
    EARLY_INFANCY = 1  # 3-6 months
    LATE_INFANCY = 2  # 6-12 months
    EARLY_TODDLER = 3  # 12-18 months
    LATE_TODDLER = 4  # 18-24 months
    
    # Preschool Period (2-4 years)
    EARLY_PRESCHOOL = 5  # 2-3 years
    LATE_PRESCHOOL = 6  # 3-4 years
    
    # Early Childhood (4-7 years)
    EARLY_CHILDHOOD = 7  # 4-5 years
    MIDDLE_CHILDHOOD = 8  # 5-6 years
    LATE_CHILDHOOD = 9  # 6-7 years
    
    # Elementary Period (7-11 years)
    EARLY_ELEMENTARY = 10  # 7-8 years
    MIDDLE_ELEMENTARY = 11  # 8-9 years
    LATE_ELEMENTARY = 12  # 9-11 years
    
    # Adolescence (11-18 years)
    EARLY_ADOLESCENCE = 13  # 11-13 years
    MIDDLE_ADOLESCENCE = 14  # 13-15 years
    LATE_ADOLESCENCE = 15  # 15-18 years
    
    # Adulthood (18+ years)
    YOUNG_ADULT = 16  # 18-21 years
    MATURE_ADULT = 17  # 21+ years
